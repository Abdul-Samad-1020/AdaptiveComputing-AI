...
## 🛠 Features  
✅ AI-based accessibility mapping  
...
```bash
git clone https://github.com/yourusername/AdaptiveComputing-AI.git
cd AdaptiveComputing-AI
...
3. Create a new branch (feature-branch-name)
